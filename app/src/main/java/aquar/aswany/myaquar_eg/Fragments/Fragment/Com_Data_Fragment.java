...
public class Com_Data_Fragment extends Fragment {
    private AlertDialog dialog;
    private final String TAG="Com_Data_Fragment";
        ...
        AndroidNetworking.get(URLS.Developer_category)
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        SetCom_DeveloperData(pojoDeveloperCategoryObj);
                    }
    ...
    private void SetCom_DeveloperData(ArrayList<Pojo_Developer_Category_Obj> pojoDeveloperCategoryObj) {
