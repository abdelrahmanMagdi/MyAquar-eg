...
public class Holy_Data_Fragment extends Fragment {
    ...
    private void Receive_Holy_Data() {
        dialog.show();
        AndroidNetworking.get(URLS.Developer_category)
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        SetHoly_DeveloperData(pojoDeveloperCategoryObj);
                    }
    ...
    private void SetHoly_DeveloperData(ArrayList<Pojo_Developer_Category_Obj> pojoDeveloperCategoryObj) {
