package aquar.aswany.myaquar_eg.Utils;

/**
 * Created by aswany on 1/14/19.
 */
...
//    //id = 1
//    public static final String products = SERVER_URL+"products_project";
//    //id=1 , cat_id=2
//    public static final String SearchWithPrice=SERVER_URL+"search_badget";
